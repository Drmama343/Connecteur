...
INSERT INTO Competence VALUES
	('BIN11', 'Réaliser un développement d’application', 1),
	('BIN12', 'Optimiser des Applications informatiques', 2),
	('BIN13', 'Administrer des Systèmes informatiques communicants complexes', 3),
	('BIN14', 'Gérer des Données de l’information', 4),
	('BIN15', 'Conduire un projet', 5),
	('BIN16', 'Travailler dans une équipe informatique', 6),
	('BIN21', 'Réaliser un développement d’application', 1),
	('BIN22', 'Optimiser des Applications informatiques', 2),
	('BIN23', 'Administrer des Systèmes informatiques communicants complexes', 3),
	('BIN24', 'Gérer des Données de l’information', 4),
	('BIN25', 'Conduire un projet', 5),
	('BIN26', 'Travailler dans une équipe informatique', 6),
	('BIN31', 'Réaliser un développement d’application', 1),
	('BIN32', 'Optimiser des Applications informatiques', 2),
	('BIN33', 'Administrer des Systèmes informatiques communicants complexes', 3),
	('BIN34', 'Gérer des Données de l’information', 4),
	('BIN35', 'Conduire un projet', 5),
	('BIN36', 'Travailler dans une équipe informatique', 6),
	('BIN41', 'Réaliser un développement d’application', 1),
	('BIN42', 'Optimiser des Applications informatiques', 2),
	('BIN43', 'Administrer des Systèmes informatiques communicants complexes', 3),
	('BIN44', 'Gérer des Données de l’information', 4),
	('BIN45', 'Conduire un projet',5),
	('BIN46', 'Travailler dans une équipe informatique', 6),
	('BIN51', 'Réaliser un développement d’application', 1),
	('BIN52', 'Optimiser des Applications informatiques', 2),
	('BIN56', 'Travailler dans une équipe informatique', 6),
	('BIN61', 'Réaliser un développement d’application', 1),
	('BIN62', 'Optimiser des Applications informatiques', 2),
	('BIN66', 'Travailler dans une équipe informatique', 3);
