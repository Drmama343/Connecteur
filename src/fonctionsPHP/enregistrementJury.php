			...
			if ($fileType == "xlsx") {
				...
				foreach ($worksheet->getRowIterator() as $row) {
					...
					switch ($semestre) {
						case "1":
							//insert ou update
							$db->insertIntoJuryAnnee(intval($data['code_nip']), 'BUT1', null, $data['RCUEs'], $data['Année']);

							$db->insertIntoJurySem(intval($data['code_nip']), '1', floatval($data['Moy']), $data['UEs'], null, intval($data['Rg']));

							//insert ou update
							$db->insertIntoMoyCompAnnee(intval($data['code_nip']), 'BIN11', 'BUT1', floatval($rowData[23]), $rowData[24]);
							$db->insertIntoMoyCompAnnee(intval($data['code_nip']), 'BIN12', 'BUT1', floatval($rowData[25]), $rowData[26]);
							$db->insertIntoMoyCompAnnee(intval($data['code_nip']), 'BIN13', 'BUT1', floatval($rowData[27]), $rowData[28]);
							$db->insertIntoMoyCompAnnee(intval($data['code_nip']), 'BIN14', 'BUT1', floatval($rowData[29]), $rowData[30]);
							$db->insertIntoMoyCompAnnee(intval($data['code_nip']), 'BIN15', 'BUT1', floatval($rowData[31]), $rowData[32]);
							$db->insertIntoMoyCompAnnee(intval($data['code_nip']), 'BIN16', 'BUT1', floatval($rowData[33]), $rowData[34]);
						...
						case "2":
							...
							//insert ou update
							$db->insertIntoMoyCompAnnee(intval($data['code_nip']), 'BIN21', 'BUT1', floatval($rowData[23]), $rowData[24]);
							$db->insertIntoMoyCompAnnee(intval($data['code_nip']), 'BIN22', 'BUT1', floatval($rowData[25]), $rowData[26]);
							$db->insertIntoMoyCompAnnee(intval($data['code_nip']), 'BIN23', 'BUT1', floatval($rowData[27]), $rowData[28]);
							$db->insertIntoMoyCompAnnee(intval($data['code_nip']), 'BIN24', 'BUT1', floatval($rowData[29]), $rowData[30]);
							$db->insertIntoMoyCompAnnee(intval($data['code_nip']), 'BIN25', 'BUT1', floatval($rowData[31]), $rowData[32]);
							$db->insertIntoMoyCompAnnee(intval($data['code_nip']), 'BIN26', 'BUT1', floatval($rowData[33]), $rowData[34]);
						...
						case "3":
							//insert ou update
							$db->insertIntoJuryAnnee(intval($data['code_nip']), 'BUT2', null, $data['RCUEs'], $data['Année']);

							$db->insertIntoJurySem(intval($data['code_nip']), '3', floatval($data['Moy']), $data['UEs'], null, intval($data['Rg']));

							//insert ou update
							$db->insertIntoMoyCompAnnee(intval($data['code_nip']), 'BIN31', 'BUT2', floatval($rowData[23]), $rowData[24]);
							$db->insertIntoMoyCompAnnee(intval($data['code_nip']), 'BIN32', 'BUT2', floatval($rowData[25]), $rowData[26]);
							$db->insertIntoMoyCompAnnee(intval($data['code_nip']), 'BIN33', 'BUT2', floatval($rowData[27]), $rowData[28]);
							$db->insertIntoMoyCompAnnee(intval($data['code_nip']), 'BIN34', 'BUT2', floatval($rowData[29]), $rowData[30]);
							$db->insertIntoMoyCompAnnee(intval($data['code_nip']), 'BIN35', 'BUT2', floatval($rowData[31]), $rowData[32]);
							$db->insertIntoMoyCompAnnee(intval($data['code_nip']), 'BIN36', 'BUT2', floatval($rowData[33]), $rowData[34]);
						...
						case "4":
							...
							//insert ou update
							$db->insertIntoMoyCompAnnee(intval($data['code_nip']), 'BIN41', 'BUT2', floatval($rowData[23]), $rowData[24]);
							$db->insertIntoMoyCompAnnee(intval($data['code_nip']), 'BIN42', 'BUT2', floatval($rowData[25]), $rowData[26]);
							$db->insertIntoMoyCompAnnee(intval($data['code_nip']), 'BIN43', 'BUT2', floatval($rowData[27]), $rowData[28]);
							$db->insertIntoMoyCompAnnee(intval($data['code_nip']), 'BIN44', 'BUT2', floatval($rowData[29]), $rowData[30]);
							$db->insertIntoMoyCompAnnee(intval($data['code_nip']), 'BIN45', 'BUT2', floatval($rowData[31]), $rowData[32]);
							$db->insertIntoMoyCompAnnee(intval($data['code_nip']), 'BIN46', 'BUT2', floatval($rowData[33]), $rowData[34]);
						...
						case "5":
							//insert ou update
							$db->insertIntoJuryAnnee(intval($data['code_nip']), 'BUT3', null, $data['RCUEs'], $data['Année']);
							
							$db->insertIntoJurySem(intval($data['code_nip']), '5', floatval($data['Moy']), $data['UEs'], null, intval($data['Rg']));

							//insert ou update
							$db->insertIntoMoyCompAnnee(intval($data['code_nip']), 'BIN51', 'BUT3', floatval($rowData[23]), $rowData[24]);
							$db->insertIntoMoyCompAnnee(intval($data['code_nip']), 'BIN52', 'BUT3', floatval($rowData[25]), $rowData[26]);
							$db->insertIntoMoyCompAnnee(intval($data['code_nip']), 'BIN56', 'BUT3', floatval($rowData[33]), $rowData[34]);
						...
						case "6":
							...
							//insert ou update
							$db->insertIntoMoyCompAnnee(intval($data['code_nip']), 'BIN61', 'BUT3', floatval($rowData[23]), $rowData[24]);
							$db->insertIntoMoyCompAnnee(intval($data['code_nip']), 'BIN62', 'BUT3', floatval($rowData[25]), $rowData[26]);
							$db->insertIntoMoyCompAnnee(intval($data['code_nip']), 'BIN66', 'BUT3', floatval($rowData[33]), $rowData[34]);
