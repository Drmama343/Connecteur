...
function insertMoyCompSem($db, $codenip, $idcomp, $idsem, $moycompsem, $avis) {
	if($db->insertIntoMoyCompSem($codenip, $idcomp, $idsem, $moycompsem, $avis) === 1)
	{
		$db->updateMoyCompSem($codenip, $idcomp, $idsem, $moycompsem, $avis);
	}
}
$db->close();
?>
