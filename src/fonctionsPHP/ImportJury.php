...
function insertJuryAnnee($db, $codenip, $annee, $nomannee, $moyannee, $rcue, $decision, $rang, $abs) {
	$val = $db->insertIntoJuryAnnee($codenip, $annee, $nomannee, $moyannee, $rcue, $decision, $rang, $abs);
	if($val === 1)
	{
		$db->updateJuryAnnee($codenip, $annee, $nomannee, $moyannee, $rcue, $decision, $rang, $abs);
	}
}
